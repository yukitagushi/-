export default {
  // SupabaseのプロジェクトURL（例: https://xyzcompany.supabase.co）
  SUPABASE_URL: "https://nhqrgdwxmaajvhumejzg.supabase.co",  // ← APIの Project URL（DBのpostgresql://ではありません）
  // Supabaseのpublic anon key
